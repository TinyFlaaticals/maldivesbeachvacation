...
var require_cocoon_js = __commonJS({
  "node_modules/cocoon-js/index.js"(exports, module) {
    ...
    if (searchInput) {
      ...
      searchInput.addEventListener("input", (e2) => {
        ...
        searchTimeout = setTimeout(() => {
          this.submitSearch(e2.target.value);
        }, 500);
      });
    }
    const sortSelect = document.querySelector("#sort-by");
    if (sortSelect) {
      sortSelect.addEventListener("change", (e2) => {
        this.submitSort(e2.target.value);
      });
    }
  }
  setPriceRange(event) {
...
// app/javascript/controllers/rails_nested_form_controller.js
var rails_nested_form_controller_default = class extends RailsNestedForm {
  connect() {
    super.connect();
...
console.log("Property.js loaded - amenities now display inline without toggle functionality");
...
var import_cocoon_js = __toESM(require_cocoon_js());
