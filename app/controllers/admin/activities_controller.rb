class Admin::ActivitiesController < AdminApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_activities_path, status: :see_other, notice: "Activity was successfully destroyed." }
