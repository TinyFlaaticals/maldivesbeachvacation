class Admin::FacilitiesController < AdminApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_facilities_path, status: :see_other, notice: "Facility was successfully destroyed." }
